...
func NewChannel(chb *ChannelBindings, opb *OperationBindings, conn net.Conn, clientSide bool) *Channel {
	res := Channel{
		Conn:              conn,
...
func (s Channel) Receive(ctx context.Context, cb func(envelope EnvelopeReader)) error {
...
func (s Channel) Send(ctx context.Context, envelopes ...EnvelopeWriter) error {
