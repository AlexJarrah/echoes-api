...
func (p ProduceClient) Publisher(ctx context.Context, address string, chb *ChannelBindings, opb *OperationBindings, security run.AnySecurityScheme) (Publisher, error) {
...
func getAuthHeaders(security run.AnySecurityScheme) (wsclient.HandshakeHeaderHTTP, error) {
	h := make(http.Header)
