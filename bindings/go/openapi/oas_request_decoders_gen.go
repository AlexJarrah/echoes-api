...
func (s *Server) decodeAddGroupRolesRequest(r *http.Request) (
	req []GroupRole,
	rawBody []byte,
	close func() error,
	rerr error,
	...
	case ct == "application/json":
		...
		var request []GroupRole
		if err := func() error {
			request = make([]GroupRole, 0)
...
func (s *Server) decodeAddUserAssetRequest(r *http.Request) (
	req *AddUserAssetReq,
	rawBody []byte,
	close func() error,
	rerr error,
...
func (s *Server) decodeCreatePlaylistRequest(r *http.Request) (
...
func (s *Server) decodeEditGroupRequest(r *http.Request) (
...
func (s *Server) decodeEditPlaylistRequest(r *http.Request) (
	...
	case ct == "application/json":
		...
		var request EditPlaylistRequest
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
...
func (s *Server) decodeEditUserAssetRequest(r *http.Request) (
	...
	case ct == "application/json":
		...
		var request EditUserAssetRequest
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
...
func (s *Server) decodeGetGlobalTopAlbumsRequest(r *http.Request) (
	...
	case ct == "application/json":
		...
		var request OptStatisticsQuery
		if err := func() error {
			request.Reset()
			if err := request.Decode(d); err != nil {
				return err
...
func (s *Server) decodeGetGlobalTopArtistsRequest(r *http.Request) (
	req OptStatisticsQuery,
	rawBody []byte,
	close func() error,
	rerr error,
...
func (s *Server) decodeGetGlobalTopTracksRequest(r *http.Request) (
	req OptStatisticsQuery,
	rawBody []byte,
	close func() error,
	rerr error,
...
func (s *Server) decodeGetLibraryPlaylistsRequest(r *http.Request) (
	...
	case ct == "application/json":
		...
		var request OptGetLibraryPlaylistsRequest
		if err := func() error {
			request.Reset()
			if err := request.Decode(d); err != nil {
				return err
...
func (s *Server) decodeGetTracksPlayStatsRequest(r *http.Request) (
	req OptStatisticsQuery,
	rawBody []byte,
	close func() error,
	rerr error,
...
func (s *Server) decodeGetUserListensByDaysRequest(r *http.Request) (
	req *DateTimeRange,
	rawBody []byte,
	close func() error,
	rerr error,
...
func (s *Server) decodeGetUserTopArtistPlayStatsRequest(r *http.Request) (
	...
	case ct == "application/json":
		...
		var request OptArtistPlayStatisticsQuery
		if err := func() error {
			request.Reset()
			if err := request.Decode(d); err != nil {
				return err
...
func (s *Server) decodeSyncRequest(r *http.Request) (
	req *SyncRequest,
	rawBody []byte,
	close func() error,
	rerr error,
...
func (s *Server) decodeUploadTrackAudioRequest(r *http.Request) (
	req *UploadTrackAudioReq,
	rawBody []byte,
	close func() error,
	rerr error,
) {
	...
	case ct == "multipart/form-data":
		...
		var request UploadTrackAudioReq
		{
			if err := func() error {
