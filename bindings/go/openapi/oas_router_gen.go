				...
				case 'p': // Prefix: "pi/"
					...
					case 'c': // Prefix: "c"
						...
						case 'h': // Prefix: "hanges"
							...
							if len(elem) == 0 {
								...
								switch r.Method {
								case "GET":
									s.handleGetChangesRequest([0]string{}, elemIsEscaped, w, r)
								default:
									s.notAllowed(w, r, notAllowedParams{
										allowedMethods: "GET",
										allowedHeaders: nil,
					...
					case 'l': // Prefix: "l"
						...
						case 'i': // Prefix: "i"
							...
							case 's': // Prefix: "stens/"
								...
								if l := len("stens/"); len(elem) >= l && elem[0:l] == "stens/" {
									elem = elem[l:]
								} else {
									break
								}
								...
								if len(elem) == 0 {
									...
									switch r.Method {
									case "DELETE":
										s.handleDeleteListenRequest([1]string{
											args[0],
										}, elemIsEscaped, w, r)
									case "GET":
										s.handleGetListenRequest([1]string{
											args[0],
										}, elemIsEscaped, w, r)
									default:
										s.notAllowed(w, r, notAllowedParams{
					...
					case 'p': // Prefix: "playlists"
						...
						if len(elem) == 0 {
							switch r.Method {
							case "POST":
								s.handleCreatePlaylistRequest([0]string{}, elemIsEscaped, w, r)
							default:
								s.notAllowed(w, r, notAllowedParams{
									allowedMethods: "POST",
						...
						case '/': // Prefix: "/"
							...
							if len(elem) == 0 {
								switch r.Method {
								case "DELETE":
									s.handleDeletePlaylistRequest([1]string{
										args[0],
									}, elemIsEscaped, w, r)
								case "GET":
									s.handleGetPlaylistRequest([1]string{
										args[0],
									}, elemIsEscaped, w, r)
								case "PATCH":
									s.handleEditPlaylistRequest([1]string{
										args[0],
									}, elemIsEscaped, w, r)
								default:
									s.notAllowed(w, r, notAllowedParams{
							...
							case '/': // Prefix: "/"
								...
								case 'r': // Prefix: "roles"
									...
									if len(elem) == 0 {
										switch r.Method {
										case "GET":
											s.handleGetPlaylistRolesRequest([1]string{
												args[0],
											}, elemIsEscaped, w, r)
										case "POST":
											s.handleSetPlaylistRolesRequest([1]string{
												args[0],
											}, elemIsEscaped, w, r)
										default:
											s.notAllowed(w, r, notAllowedParams{
									...
									case '/': // Prefix: "/"
										...
										if len(elem) == 0 {
											...
											switch r.Method {
											case "DELETE":
												s.handleDeletePlaylistRoleRequest([2]string{
													args[0],
													args[1],
												}, elemIsEscaped, w, r)
											case "PATCH":
												s.handleEditPlaylistRoleRequest([2]string{
													args[0],
													args[1],
												}, elemIsEscaped, w, r)
											default:
								...
								case 't': // Prefix: "tracks"
									...
									if len(elem) == 0 {
										switch r.Method {
										case "GET":
											s.handleGetPlaylistTracksRequest([1]string{
												args[0],
											}, elemIsEscaped, w, r)
										case "POST":
											s.handleAddPlaylistTracksRequest([1]string{
												args[0],
											}, elemIsEscaped, w, r)
										default:
											s.notAllowed(w, r, notAllowedParams{
									...
									case '/': // Prefix: "/"
										...
										if len(elem) == 0 {
											...
											switch r.Method {
											case "DELETE":
												s.handleDeletePlaylistTrackRequest([2]string{
													args[0],
													args[1],
												}, elemIsEscaped, w, r)
											case "PATCH":
												s.handleEditPlaylistTrackRequest([2]string{
													args[0],
													args[1],
												}, elemIsEscaped, w, r)
											default:
					...
					case 's': // Prefix: "s"
						...
						case 't': // Prefix: "tatistics/"
							...
							case 'u': // Prefix: "user/"
								...
								case 't': // Prefix: "t"
									...
									switch elem[0] {
									case 'o': // Prefix: "op/artist-plays"

										if l := len("op/artist-plays"); len(elem) >= l && elem[0:l] == "op/artist-plays" {
											elem = elem[l:]
										} else {
											break
										}
									...
									case 'r': // Prefix: "racks/plays"

										if l := len("racks/plays"); len(elem) >= l && elem[0:l] == "racks/plays" {
											elem = elem[l:]
										} else {
											break
										}
										...
										if len(elem) == 0 {
											...
											switch r.Method {
											case "POST":
												s.handleGetTracksPlayStatsRequest([0]string{}, elemIsEscaped, w, r)
											default:
												s.notAllowed(w, r, notAllowedParams{
													allowedMethods: "POST",
						...
						case 'y': // Prefix: "ync"
							...
							if len(elem) == 0 {
								...
								switch r.Method {
								case "POST":
									s.handleSyncRequest([0]string{}, elemIsEscaped, w, r)
								default:
									s.notAllowed(w, r, notAllowedParams{
										allowedMethods: "POST",
				...
				case 'p': // Prefix: "pi/"
					...
					case 'c': // Prefix: "c"
						...
						case 'h': // Prefix: "hanges"
							...
							if len(elem) == 0 {
								...
								switch method {
								case "GET":
									r.name = GetChangesOperation
									r.summary = "Get changes visible to the user."
									r.operationID = "getChanges"
									r.operationGroup = ""
									r.pathPattern = "/api/changes"
									r.args = args
									r.count = 0
									return r, true
								default:
						...
						case 'i': // Prefix: "i"
							...
							case 's': // Prefix: "stens/"
								...
								if len(elem) == 0 {
									...
									switch method {
									case "DELETE":
										r.name = DeleteListenOperation
										r.summary = "Delete listen"
										r.operationID = "deleteListen"
										r.operationGroup = ""
										r.pathPattern = "/api/listens/{listen_id}"
										r.args = args
										r.count = 1
										return r, true
									case "GET":
										r.name = GetListenOperation
										r.summary = "Get listen"
										r.operationID = "getListen"
										r.operationGroup = ""
										r.pathPattern = "/api/listens/{listen_id}"
										r.args = args
										r.count = 1
					...
					case 'p': // Prefix: "playlists"
						...
						if len(elem) == 0 {
							switch method {
							case "POST":
								r.name = CreatePlaylistOperation
								r.summary = "Create a playlist"
								r.operationID = "createPlaylist"
								r.operationGroup = ""
								r.pathPattern = "/api/playlists"
								r.args = args
								r.count = 0
								return r, true
							default:
						...
						case '/': // Prefix: "/"
							...
							if len(elem) == 0 {
								switch method {
								case "DELETE":
									r.name = DeletePlaylistOperation
							...
							case '/': // Prefix: "/"
								...
								case 'r': // Prefix: "roles"
									...
									if len(elem) == 0 {
										switch method {
										case "GET":
											r.name = GetPlaylistRolesOperation
											...
											return r, true
										case "POST":
											r.name = SetPlaylistRolesOperation
									...
									case '/': // Prefix: "/"
										...
										if len(elem) == 0 {
											...
											switch method {
											case "DELETE":
												r.name = DeletePlaylistRoleOperation
												...
												return r, true
											case "PATCH":
												r.name = EditPlaylistRoleOperation
								...
								case 't': // Prefix: "tracks"
									...
									if len(elem) == 0 {
										switch method {
										case "GET":
											r.name = GetPlaylistTracksOperation
											...
											return r, true
										case "POST":
											r.name = AddPlaylistTracksOperation
									...
									case '/': // Prefix: "/"
										...
										if len(elem) == 0 {
											...
											switch method {
											case "DELETE":
												r.name = DeletePlaylistTrackOperation
												...
												return r, true
											case "PATCH":
												r.name = EditPlaylistTrackOperation
					...
					case 's': // Prefix: "s"
								...
								case 't': // Prefix: "t"
									...
									case 'r': // Prefix: "racks/plays"
										...
										if len(elem) == 0 {
											...
											switch method {
											case "POST":
												r.name = GetTracksPlayStatsOperation
												r.summary = "Get all tracks' play count & time in a specified time range"
												r.operationID = "getTracksPlayStats"
												r.operationGroup = ""
												r.pathPattern = "/api/statistics/user/tracks/plays"
												r.args = args
												r.count = 0
												return r, true
											default:
						...
						case 'y': // Prefix: "ync"
							...
							if len(elem) == 0 {
								...
								switch method {
								case "POST":
									r.name = SyncOperation
									r.summary = "Compare differences between a snapshot and a provided state"
									r.operationID = "sync"
									r.operationGroup = ""
