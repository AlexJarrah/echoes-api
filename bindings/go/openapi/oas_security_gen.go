...
var operationRolesCookieAuth = map[string][]string{
	...
	AddGroupRolesOperation:             []string{},
	AddMessageReactionOperation:        []string{},
	AddPlaylistTracksOperation:         []string{},
	AddToLibraryOperation:              []string{},
	AddUserAssetOperation:              []string{},
	CreateGroupOperation:               []string{},
	CreatePlaylistOperation:            []string{},
	DeleteGroupOperation:               []string{},
	DeleteGroupRoleOperation:           []string{},
	DeleteListenOperation:              []string{},
	DeleteMessageOperation:             []string{},
	DeleteMessageReactionOperation:     []string{},
	DeletePlaylistOperation:            []string{},
	DeletePlaylistRoleOperation:        []string{},
	DeletePlaylistTrackOperation:       []string{},
	DeleteUserAssetOperation:           []string{},
	EditGroupOperation:                 []string{},
	EditMessageOperation:               []string{},
	EditPlaylistOperation:              []string{},
	EditPlaylistRoleOperation:          []string{},
	EditPlaylistTrackOperation:         []string{},
	EditUserAssetOperation:             []string{},
	GetAlbumOperation:                  []string{},
	GetArtistOperation:                 []string{},
	GetChangesOperation:                []string{},
	...
	GetLibraryPlaylistsOperation:       []string{},
	GetLibrarySearchIndexOperation:     []string{},
	GetLibraryTracksOperation:          []string{},
	GetListenOperation:                 []string{},
	GetListenSessionsOperation:         []string{},
	GetLyricsOperation:                 []string{},
	GetMessageThreadOperation:          []string{},
	GetMessagesOperation:               []string{},
	GetPlaylistOperation:               []string{},
	GetPlaylistRolesOperation:          []string{},
	GetPlaylistTracksOperation:         []string{},
	GetRelationsDetailsOperation:       []string{},
	GetTrackOperation:                  []string{},
	GetTracksPlayStatsOperation:        []string{},
	GetUserAssetOperation:              []string{},
	GetUserAssetsOperation:             []string{},
	GetUserDetailsOperation:            []string{},
	GetUserIntegrationsOperation:       []string{},
	GetUserListenSessionsOperation:     []string{},
	GetUserListensByDaysOperation:      []string{},
	GetUserRelationsOperation:          []string{},
	GetUserTopArtistPlayStatsOperation: []string{},
