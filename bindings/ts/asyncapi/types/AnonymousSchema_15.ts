...
class AnonymousSchema_15 {
  private _sessionId: string;
  private _trackId: string;
  private _trackName: string;
  private _artists: AnonymousSchema_20[];
  ...
  get artists(): AnonymousSchema_20[] { return this._artists; }
  set artists(artists: AnonymousSchema_20[]) { this._artists = artists; }
...
export default AnonymousSchema_15;
