import AnonymousSchema_53 from './AnonymousSchema_53';
class AnonymousSchema_48 {
  private _sessionId: string;
  private _trackId: string;
  private _trackName: string;
  private _artists: AnonymousSchema_53[];
  ...
  get artists(): AnonymousSchema_53[] { return this._artists; }
  set artists(artists: AnonymousSchema_53[]) { this._artists = artists; }
...
export default AnonymousSchema_48;
