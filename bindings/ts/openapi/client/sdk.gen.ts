 ...
 * Get OpenAPI schema.
 */
export const getOpenApi = <ThrowOnError extends boolean = false>(options?: Options<GetOpenApiData, ThrowOnError>) => (options?.client ?? client).get<GetOpenApiResponses, unknown, ThrowOnError>({ url: '/openapi.yaml', ...options });

/**
 * Get AsyncAPI schema.
 */
export const getAsyncApi = <ThrowOnError extends boolean = false>(options?: Options<GetAsyncApiData, ThrowOnError>) => (options?.client ?? client).get<GetAsyncApiResponses, unknown, ThrowOnError>({ url: '/asyncapi.yaml', ...options });
 ...
 */
export const getUserListensByDays = <ThrowOnError extends boolean = false>(options: Options<GetUserListensByDaysData, ThrowOnError>) => (options.client ?? client).post<GetUserListensByDaysResponses, GetUserListensByDaysErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'auth_token',
            type: 'apiKey'
